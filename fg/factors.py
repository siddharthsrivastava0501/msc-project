...
class DynamicsFactor:
    ...
    '''
    def __init__(self, Vt_id, Vtp_id, Sigma_id, lmbda_in : Tensor, factor_id, graph : Graph, huber = False, connected_params = []) -> None:
        self.Vt_id = Vt_id 
        self.Vtp_id = Vtp_id
    ...
    def _h_fn(self, Et, It, Etp, Itp, Et_ext, It_ext, ai, bi, ci, di, P, Q):
        h_ext = Etp - (Et + 0.01 * dEdt(Et, It, Et_ext, ai, bi, P))
        h_inh = Itp - (It + 0.01 * dIdt(Et, It, It_ext, ci, di, Q))
